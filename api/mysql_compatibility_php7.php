...
if(!function_exists('mysql_connect') && function_exists('mysqli_connect')){
	...
	function mysql_connect($host,$user,$pass,$db,$new_link=false,$clFlags=0){
	...
	function mysql_query($query,$res=NULL){	 
		if(!$res){$res=$GLOBALS['_MysqliSvRes'];}else{$GLOBALS['_MysqliSvRes']=$res;}
			return mysqli_query($res,$query,MYSQLI_STORE_RESULT);
		}
